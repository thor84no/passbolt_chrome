 ...
 * @param port
 */
PageMod.prototype.__onDisconnect = function(port) {
  if (this.iframe) {
    // iframes listeners are not reconnected on tab refresh for example
    // so we manually reset them when the other side disconnect
